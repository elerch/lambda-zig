...
// zig build -Drelease-safe && strip zig-out/bin/bootstrap && zip -j9 function.zip zig-out/bin/bootstrap && aws lambda update-function-code --function-name zig-test --zip-file fileb://function.zip
